...
public class GetInfoForAddEquipment extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetInfoForAddEquipment() {
		super();
	}
			...
			throws ServletException, IOException 
	{
		...
		try {
			list = DAOFactory.getIEquipmentTypeDAOInstance().findAll();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		String projectName = request.getParameter("project");
		String subProjectName = request.getParameter("subProject");
