...
public class AllEquipmentInPro extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AllEquipmentInPro() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			request.setAttribute("all", DAOFactory.getEquipmentDAO().findBySubPro(request.getParameter("name"))) ;
		} catch (Exception e) {
