          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 用户基本信息列表 >> 修改用户信息</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
<%		
 ...
 %>
  ...
  <tr>
    <th align="right" valign="middle" scope="row">&nbsp;</th>
    <td align="left" valign="middle"><input type="submit" value="修改" /><input type="reset" value="重置"  /></td>
  </tr>
</table></form>
</td>
  </tr>
