          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">统计分析 >> 月报表 >> <%=superName%></span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
%>
<div class="month"><img src="<%= graphURL1 %>"width=800 height=300 border=0 usemap="#<%= filename1 %>"><p><a href="EquipmentForMonth?year=<%=year%>&month=<%=month%>&subName=<%=pro.getName()%>&superName=<%=superName%>">点击查看<%=pro.getName()%>设备报表</a></p></div>
<%
	}
%>
</div>
