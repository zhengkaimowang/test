...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">设备管理 >> <%=superName%> >> <%=name%> >> 设备类型</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
      <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">条形码</span>
        </div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">设备名称</span>
        </div></td>
        <td width="25%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">地址</span></div></td>
        <td width="12%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">生产日期</span></div></td>
        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">生产商</span></div></td>
...
%>
      ...
      <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE19"><%=eq.getCode()%></span></div></td>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><a href="EquipmentRemove?code=<%=eq.getCode()%>&subname=<%=eq.getSubproject()%>&superName=<%=superName%>">删除</a></span></div></td>
        </tr>
<%
			}
	}
%>
  ...
  <tr>
	...
	{
	%>
	<a href = "AllEquipmentInPro?pageNow=<%=pageBefore%>&name=<%=name%>&superName=<%=superName%>">上一页</a>
	<%
	}
	%>
    </div></td>
	...
	{
	%>
	<a href = "AllEquipmentInPro?name=<%=name%>&superName=<%=superName%>&pageNow=<%=pageNext%>">下一页</a>
	<%
	}
	%>
    </div></td>
              <td width="37" class="STYLE22"><div align="center">转到</div></td>
          <form action = "AllEquipmentInPro?name=<%=name%>&superName=<%=superName%>" method = "post">
...
<script language="javascript">
	function add(){
		window.parent.rightFrame.location.href = "GetInfoForAddEquipment?project=<%=superName%>&subProject=<%=name%>";
		}
</script>
</html>
